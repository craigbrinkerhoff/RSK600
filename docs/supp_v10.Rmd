...
## Figure S2
![Figure S2: Map of simulated SWOT river locations around the world. Also includes approximate location of the $CO_2$ timeseries used in this study (Figure S3). Note that river locations are approximate as some hydraulic models are not geo-referenced.](cache/maps/figS2.jpg)
...
## Figure S4
![Figure S4: Observed (orange) versus BIKER-inferred (green) timerseries of daily $k_{600}$ for the 47 SWOT-simulated rivers under the 'no-measurement-error' scenario. Note that the y axis is normalized by maximum observed values to compare across rivers.](cache/validation/figS4.jpg)

## Figure S5
![Figure S5: Observed (orange) versus BIKER-inferred (green) timerseries of daily $k_{600}$ for 16 rivers under the 'measurement-error' scenario. Note that the y axis is normalized by maximum observed values to compare across rivers.](cache/validation/figS5.jpg)
...
|Raymond 2012|$D=0.409Q^{0.294}$|$\bar{U}=0.194Q^{0.285}$|@raymondScalingGasTransfer2012|1,026 measurements across the United States|@raymondScalingGasTransfer2012|
