...
#statistical tests for reviewer 1############################################
#test 1--------------------------------------------------------------------
...
lm_log_hydraulicallyWide_reynolds_eD_test1 <- lm_log_hydraulicallyWide_reynolds_eD #save for later
...
summary(lm_log_hydraulicallyWide_reynolds_eD)
lm_log_hydraulicallyWide_reynolds_eD_test2 <- lm_log_hydraulicallyWide_reynolds_eD #save for later
...
#save models to file--------------------------------------------
#note the bayes model is saved in the main script `swot_k_model_v4.R`
models <- data.frame('name'=c('theoretical', 'empirical'),
                     'r2'=c(summary(lm_log_hydraulicallyWide_reynolds_eD_test1)$r.squared,
                            summary(lm_log_hydraulicallyWide_reynolds_eD_test2)$r.squared),
                     'coef'=c(beta_1,
                              coef(lm_log_hydraulicallyWide_reynolds_eD_test2)[1]),
                     'slope1'=c(NA,
                                coef(lm_log_hydraulicallyWide_reynolds_eD_test2)[2]),
                     'slope2'=c(NA,
                                coef(lm_log_hydraulicallyWide_reynolds_eD_test2)[3]),
                     'slope3'=c(NA,
                                coef(lm_log_hydraulicallyWide_reynolds_eD_test2)[4])
)
write.csv(models, 'cache/k600_theory/k_stats_models.csv')
