...
valPlot <- ggplot(full_output, aes(x=(kobs), y=(kest_mean))) +
  ...
  annotate("text", label = paste0('RMSE: 10^', rmse, ' m/dy'), x = 10^-0.25, y = 10^1, size = 5, colour = "black")+
  annotate("text", label = paste0('r2: ', r2), x = 10^-0.25, y = 10^0.8, size = 5, colour = "black")
