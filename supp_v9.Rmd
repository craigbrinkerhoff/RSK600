...
|---------------|-----------|--------------|---------------|------------------|
|Correlation Coefficient|$r$| $\sqrt{1-(\frac{\sum\limits_{i=1}^{N_t}{(k_{600, i}-\hat{k_{600_i}})^2}}{\sum{(k_{600, i}-\bar{k_{600}})^2}})}$ |1|-1 to 1|
|Normalized root-mean-square error|NRMSE| $\sqrt{\frac{1}{N_t}\sum\limits_{i=1}^{N_t}(\frac{\hat{k_{600, i}}-k_{600, i}}{\bar{k_{600, i}}})^2}$ |0|0 to ∞|
|Kling-Gupta Efficiency|KGE|$1 - \sqrt{ (r(k_{600_i}, \hat{k_{600_i}}) - 1)^2 + (\frac{\mu_{\hat{k_{600_i}}} }{\mu_{k_{600_i}}} - 1)^2 + (\frac{ \sigma _{\hat{k_{600_i}}} / \mu _{\hat{k_{600_i}}} }{ \sigma_{k_{600_i}} / \mu_{k_{600_i}}} - 1)^2 }$|1|-∞ to 1|
|Mean Absolute Error|MAE| $\frac{\sum\limits_{i=1}^{N_t}(|\hat{k_{600_i}}-k_{600_i})|)}{n})$ |0|0 to ∞|
